    ...
    public function profile($flag = null, $staff_id = null) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            ...
            // 登録解除
                ...
                $sql = '';
                $sql = $sql.' UPDATE softlife_slnext.staff_'.$selected_class; 
                $sql = $sql.' SET id = '.$this->request->data['StaffMaster']['staff_id'].', kaijo_flag = 1, modified = CURRENT_TIMESTAMP()';  
                $sql = $sql.' WHERE softlife_slnext.staff_'.$selected_class.'.id = '.$this->request->data['StaffMaster']['staff_id'];
            ...
            // メモ追加
                ...
                $sql = '';
                $sql = $sql.' INSERT INTO softlife_slnext.staff_memos (memo, class, username, staff_id, created)';
